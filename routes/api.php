...
Route::get('customers/collectionSize', 'App\Http\Controllers\CustomerController@getCollectionSize');
...
Route::get('rentals/collectionSize', 'App\Http\Controllers\RentalController@getCollectionSize');
